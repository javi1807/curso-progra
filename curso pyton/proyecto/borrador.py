...
# Funciones para crear las tablas si no existen
def create_user_db():
...
def create_suggestion_db():
    conexion = sqlite3.connect(r'D:\Programas\DB.Browser.for.SQLite-3.12.2-win64\DB Browser for SQLite\base_datos.db')
    cursor = conexion.cursor()
    cursor.execute("""
